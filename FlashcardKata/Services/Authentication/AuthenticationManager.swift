...
final class AuthenticationManager: NSObject, ObservableObject {
    ...
    let googleSignInService = GoogleAuthenticationService()
    ...
    func signInWithGoogle() async {
        await googleSignInService.signIn(authenticationManager: self)
    }
    ...
    private func reauthenticateWithGoogle() async throws {
        try await googleSignInService.reauthenticate()
    }
