...
struct MockData {
    ...
    static let deckIDs = (0..<3).map { _ in UUID().uuidString }
    static let subdeckIDs = (0..<10).map { _ in UUID().uuidString }
    ...
    // MARK: - Flashcard IDs
    static let flashcardIDs = (0..<24).map { _ in UUID().uuidString }
...
extension MockData {
    ...
    static let flashcard1 = Flashcard(
        ...
        backText: """
            ...
            It is often used to describe things that are fleeting or temporary,
            like the beauty of a sunset or a short-lived trend.
        """
    )
    static let flashcard2 = Flashcard(
        ...
        backText: """
            ...
            This can refer to actions, explanations, or writing.
        """
    )
    ...
    static let flashcard3 = Flashcard(
        ...
        backText: """
            The smallest integer divisible by both 18 and 30 is the least common multiple (LCM) of 18 and 30.
            The prime factorizations of 18 and 30 are 18 = 2 * 3^2 and 30 = 2 * 3 * 5.
            The LCM is obtained by taking the highest power of each prime factor: LCM = 2 * 3^2 * 5 = 90.
            Therefore, the smallest integer n is 90.
        """
    )
    static let flashcard4 = Flashcard(
        ...
        deckID: subdeckIDs[1],
        frontText: """
            In how many ways can 5 people be arranged in a line if 2
            specific people must always be next to each other?
        """,
        backText: """
            Treat the 2 specific people as one block.
            This reduces the problem to arranging 4 blocks (the pair and the other 3 people).
            The number of ways to arrange these 4 blocks is 4! = 24.
            Since the 2 specific people can be arranged within their block in 2 ways,
            the total number of arrangements is 4! * 2 = 48.
        """
    )
    ...
    static let flashcard5 = Flashcard(
        ...
        backText: """
            ...
            while let is used to declare a constant whose value cannot be changed once it is assigned.
        """,
    ...
    static let flashcard6 = Flashcard(
        ...
        backText: """
            Guard is used to exit a scope early if a condition isn't met,
            typically in functions and loops. It's useful for validating
            input before proceeding with the function.
        """,
    ...
    static let flashcard22 = Flashcard(
        ...
        backText: """
            Optionals in Swift are used to handle the absence of a value.
            An optional can either hold a value or be nil,
            allowing safe handling of variables that may not have a value.
        """,
    ...
    static let flashcard7 = Flashcard(
        ...
        backText: """
            A closure in Swift is a self-contained block of functionality
            that can be passed around and used in your code. Closures can capture and store references
            to variables and constants from the surrounding context.
        """
    )
    static let flashcard8 = Flashcard(
        ...
        backText: """
            Optional binding in Swift is a technique used to safely unwrap optionals.
            It helps prevent runtime errors if the optional value is nil.
        """
    )
    ...
    static let flashcard9 = Flashcard(
        ...
        backText: """
            To reverse a string in Swift, you can use the .reversed() method.
            For example: let reversed = string.reversed()
        """
    )
    static let flashcard10 = Flashcard(
        ...
        backText: """
            To check if a number is prime, you can use a loop to check divisibility:
            for i in 2..<num { if num % i == 0 { return false } } return true.
        """
    )
    ...
    static let flashcard11 = Flashcard(
        ...
        backText: """
            Konnichiwa means Hello or Good afternoon in Japanese.
            It is a common greeting used in the middle of the day.
            Example sentence: Konnichiwa! How are you today?
        """
    )
    static let flashcard12 = Flashcard(
        ...
        backText: """
            Arigatou gozaimasu means Thank you or Thank you very much in Japanese.
            It is a polite expression used to show gratitude.
            Example sentence: Arigatou gozaimasu for helping me with the project!
        """
    )
    static let flashcard13 = Flashcard(
        ...
        backText: """
            Sayounara means Goodbye in Japanese. It is a formal way of bidding farewell,
            typically used when you are not expecting to see the person again soon.
            Example sentence: Sayounara! I hope to see you again soon.
        """
    )
    ...
    static let flashcard14 = Flashcard(
        ...
        backText: """
            '私は学生です' (Watashi wa gakusei desu) means 'I am a student.'
            '私' (watashi) means 'I', 'は' (wa) is the topic marker, '学生' (gakusei) means 'student',
            and 'です' (desu) is the polite form of the verb 'to be'.
        """
    )
    static let flashcard15 = Flashcard(
        ...
        backText: """
            ...
            It is pronounced 'wa' although written as 'は'.
            Example sentence: 私は学生です (I am a student).
        """
    )
    static let flashcard16 = Flashcard(
        ...
        backText: """
            いただきます (Itadakimasu) is a phrase said before eating, expressing gratitude for the meal.
            It shows respect to the people who prepared the food.
            Example: いただきます、ありがとうございました (Itadakimasu, thank you very much).
        """
    )
    ...
    static let flashcard18 = Flashcard(
        ...
        deckID: deckIDs[1],
        frontText: """
            What are the main differences between value types (like structs)
            and reference types (like classes) in Swift?
        """,
        backText: """
            Value types (structs, enums) are copied when assigned to a new variable or passed to a function,
            while reference types (classes) are passed by reference,
            meaning changes to one instance affect all references.
        """
    )
    static let flashcard19 = Flashcard(
        ...
        backText: """
            Swift uses `do-catch` for error handling. You place throwing functions inside a `do` block
            and catch errors with a `catch` block to handle them appropriately.
        """
    )
    ...
    static let flashcard20 = Flashcard(
        ...
        backText: """
            ...
            Hiragana is used for native words and grammatical elements, Katakana for foreign words and onomatopoeia,
            and Kanji for Chinese characters that represent words or ideas.
        """
    )
    static let flashcard21 = Flashcard(
        ...
        backText: """
            Japanese follows a Subject-Object-Verb (SOV) order, whereas English follows a
            Subject-Verb-Object (SVO) order.
            For example, 'I eat sushi' in English would be structured as 'I sushi eat' in Japanese.
        """
    )
}
