...
public final class WebViewService: ObservableObject {
    ...
    init(urlString: String? = nil, showWebView: Bool = false, showAlert: Bool = false, alertTitle: String = "", alertMessage: String = "", webViewURL: URL? = nil) {
    ...
    func loadWebView(urlString: String, type: WebViewType) {
        let allowedURL = [ContentConstants.ContentStrings.privatePolicyURL, ContentConstants.ContentStrings.termsAndConditionsURL]
