...
final class ReviewSessionSummaryService {
    ...
    init() {
        self.databaseService = FirestoreService<ReviewSessionSummary, Date>(collectionPath: collectionPath, orderByKeyPath: \ReviewSessionSummary.completedDate, orderDirection: .descending)
    }
