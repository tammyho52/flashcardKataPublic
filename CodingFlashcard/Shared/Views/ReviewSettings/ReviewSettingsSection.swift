...
struct ReviewSettingsSection: View {
    ...
    var body: some View {
        Group {
            ...
            LabeledToggleRow(isOn: $reviewSettings.showHint, labelText: "Show Hint", symbol: ContentConstants.Symbols.hint)
            LabeledToggleRow(isOn: $reviewSettings.showDifficultyLevel, labelText: "Show Difficulty Level", symbol: ContentConstants.Symbols.difficultyLevel)
            LabeledToggleRow(isOn: $reviewSettings.showFlashcardDeckName, labelText: "Include Deck Name", symbol: ContentConstants.Symbols.deck)
        }
