...
struct SelectAllScreen<ParentItem: Identifiable & UUIDIdentifiable & Hashable, SubItem: Identifiable & UUIDIdentifiable & Hashable>: View {

    @State var expandAllDeckHelper = ExpandAllHelper()
    @State private var selectAllDeckHelper = SelectAllHelper()
    @State var parentItemsWithSubItems: [(ParentItem, [SubItem])] = []
