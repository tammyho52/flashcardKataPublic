...
struct ColoredGlobalNavigationBarStyle: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            ...
            .background(
                LinearGradient(
                    colors: disableBackgroundColor ? [Color.clear] : [backgroundGradientPrimaryColor.opacity(0.1), backgroundGradientSecondaryColor.opacity(0.1)],
...
extension ColoredGlobalNavigationBarStyle {
    init(backgroundGradientColors: (navigationBarBackground: Color, backgroundGradientPrimaryColor: Color, backgroundGradientSecondaryColor: Color), disableBackgroundColor: Bool) {
...
#Preview {
    NavigationStack {
        ...
        .modifier(ColoredGlobalNavigationBarStyle(navigationBarBackground: .blue, backgroundGradientPrimaryColor: .blue, backgroundGradientSecondaryColor: .white, disableBackgroundColor: false))
    }
}
#endif
