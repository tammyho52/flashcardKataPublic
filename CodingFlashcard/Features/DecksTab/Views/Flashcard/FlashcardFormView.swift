...
struct FlashcardFormView: View {
    @State var optionalSectionExpanded: Bool = true
...
#Preview {
    NavigationStack {
        FlashcardFormView(flashcard: .constant(Flashcard.sampleFlashcard), focusedField: .constant(.frontText), showDeleteFlashcardButton: true)
    }
}
#endif
