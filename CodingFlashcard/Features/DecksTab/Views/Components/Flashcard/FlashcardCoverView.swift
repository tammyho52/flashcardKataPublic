...
#if DEBUG
#Preview {
    FlashcardCoverView(showModifyFlashardButtons: .constant(true), flashcard: .constant(Flashcard.sampleFlashcard), theme: .blue, navigateToFlashcardAction: { id in }, deleteFlashcardAction: { id in }, modifyFlashcardAction: { id in })
}
#endif
