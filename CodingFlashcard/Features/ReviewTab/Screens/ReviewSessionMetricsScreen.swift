...
#if DEBUG
#Preview {
    ReviewSessionMetricsScreen(reviewSessionSummary: ReviewSessionSummary.sampleArray[0], completedReviewModeMessage: "Great Job!")
        .padding()
}

#Preview {
    ReviewSessionMetricsScreen(reviewSessionSummary: ReviewSessionSummary.sampleArray[1], completedReviewModeMessage: "Great Job!")
        .padding()
}

#Preview {
    ReviewSessionMetricsScreen(reviewSessionSummary: ReviewSessionSummary.sampleArray[2], completedReviewModeMessage: "Great Job!")
        .padding()
}

#Preview {
    ReviewSessionMetricsScreen(reviewSessionSummary: ReviewSessionSummary.sampleArray[3], completedReviewModeMessage: "Great Job!")
        .padding()
}
#endif
